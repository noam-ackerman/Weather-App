...
function formatLocalTime(props) {
  ...
  let localTimeZone = props.timezone / 3600;
  ...
  let day = new Date(props.dt * 1000);
  let dayOffset = day.getTimezoneOffset() * 60;
  day.setSeconds(day.getSeconds() + dayOffset + props.timezone);
  let days = [
    "Sunday",
    "Monday",
    "Tuesday",
